...
// This value should be set when the matrices of the instanced
// mesh are expected to be updated in the `tick` function
...
// // Tip 31, 32, 34 and 35
// Note: Try to do calculations in vertex shader and send them
// to fragment shader using varyings when possible
